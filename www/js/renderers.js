...
(function initializeRenderers() {
    ...
    function dropDownRenderer(XMLDoc) {
        ...
        this.addToListenersList('change', updateDropDownAnswer);
        ...
        function updateDropDownAnswer(e, row, questionId) {
            var selectElement = e.target,
                ...
                newResponsesString, responseObject;
    ...
    function cascadedropDownRenderer(XMLDoc) {
        var doc = XMLDoc || this.XMLDoc, htmlResult, selectElement;
        htmlResult = datadropDownRenderer.call(this, doc);

        selectElement = htmlResult.getElementsByTagName('select')[0];

        var listenersList = this.getListenersList('change');
